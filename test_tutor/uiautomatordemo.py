...
if __name__ ==  "__main__":
    ...
    app = Pywin()
    tool_name = "C:\\Users\\wcf\\AppData\\Local\\Programs\\shuangshi-blackboard\\双师未来黑板.exe"
    window_name = "blackboard"
    app.run(tool_name)
    time.sleep(100)
    app.connect(window_name)
    app.click(window_name, '备课')
    app.click(window_name, '6')
    app.click(window_name, u'1')
    app.click(window_name, u'5')
    app.click(window_name, u'0')
    app.click(window_name, u'3')
    app.click(window_name, u'4')
    time.sleep(4)
